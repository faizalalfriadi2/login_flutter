...
class Myedit extends StatefulWidget {
  ...
  const Myedit({Key? key, required this.dataEdit}) : super(key: key);
...
class _MyeditState extends State<Myedit> {
  ...
  void edit() async {
    ...
    var res = await Network().authData(data, '/edit');
    var body = json.decode(res.body);

    print(body);
    if (body['status'] == 1) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("edit Berhasil")));
    } else {
      var pesanError = "";
      if (body['reason'] != null) {
        pesanError = body['reason'][0];
      } else {
        pesanError = "Gagal edit";
      }
